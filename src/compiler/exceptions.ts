...
abstract class CompilerError {
    ...
    constructor(file: string, line: string, lineNumber: number, lineIndex: number) {
        this.file = file;
        this.line = line;
...
export class SyntaxError extends CompilerError {
    ...
    constructor(file: string, line: string, lineNumber: number, lineIndex: number, expectedToken: string | TokenType | (string | TokenType)[], info?: string) {
...
export class NameError extends CompilerError {
    constructor(file: string, line: string, lineNumber: number, lineIndex: number, expectedName: string, message: string) {
        super(file, line, lineNumber, lineIndex);
...
export class ReferenceError extends CompilerError {
    constructor(file: string, line: string, lineNumber: number, lineIndex: number, message: string) {
        super(file, line, lineNumber, lineIndex);
