...
export default class Parser {
  ...
  public commandType(): CommandType {
    if (this.currentCommand.startsWith("@")) return CommandType.A_COMMAND;
    if (this.currentCommand.startsWith("(")) return CommandType.L_COMMAND;
